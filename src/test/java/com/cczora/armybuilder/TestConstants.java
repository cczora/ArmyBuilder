...
public class TestConstants {
    ...
    public final static UUID factionTypeId = UUID.fromString("205fe7d0-ed75-4d18-a2f5-7d5324e27f0e"); //Necrons
    ...
    public final static UUID detachmentTypeId = UUID.fromString("65d6447a-9057-4187-b26b-a38cb018901d"); //Air Wing

    public final static UUID unitId = UUID.fromString("fa9029f8-414f-49bb-a279-212b3f4c536a");
    public final static UUID unitTypeId = UUID.fromString("853dff0e-0a48-4081-a11f-5d1e7dd0cbc3"); //Flyer
